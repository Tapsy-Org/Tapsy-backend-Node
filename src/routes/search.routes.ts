...
/**
 * @swagger
 * /api/search/categories/{categoryIds}:
 *   post:
 *     summary: Get businesses by category
 *     description: |
 *       Get businesses filtered by specific categories with advanced filtering options.
 *       Supports location-based filtering, rating filters, and various sorting options.
 *     tags: [Search]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *               search:
 *                 type: string
 *                 description: Additional text search within category
 *               latitude:
 *                 type: number
 *                 minimum: -90
 *                 maximum: 90
 ...
 *       Useful for discovering popular businesses in the area.
 *     tags: [Search]
 *     security:
 *       - bearerAuth: []
 *     parameters:
...
/**
 * @swagger
 * /api/search/business/{businessId}:
 *   get:
